...
describe('MenuIcon', () => {
  describe('Rendering', () => {
    ...
    it('should render with custom className', () => {
      render(<MenuIcon className="custom-class" />);
  ...
  describe('SVG Attributes', () => {
    ...
    it('should contain the correct SVG structure', () => {
      ...
      // Verify the SVG contains the expected path content (hamburger menu lines)
      expect(svg.innerHTML).toContain('M4 6h16M4 12h16M4 18h16');
  ...
  describe('Styling', () => {
    it('should apply both default and custom classes', () => {
      render(<MenuIcon className="my-custom-class another-class" />);
  ...
  describe('Component Props', () => {
    it('should handle undefined props gracefully', () => {
      render(<MenuIcon className={undefined} size={undefined} />);
  ...
  describe('Menu Icon Semantics', () => {
    it('should represent a typical hamburger menu icon', () => {
      render(<MenuIcon />);
      
      const svg = screen.getByRole('img');
      // The menu icon should contain three horizontal lines
      expect(svg.innerHTML).toContain('M4 6h16'); // Top line
      expect(svg.innerHTML).toContain('M4 12h16'); // Middle line  
      expect(svg.innerHTML).toContain('M4 18h16'); // Bottom line
    });
  });
});
